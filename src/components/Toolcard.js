...
const ToolsPage = () => {
  return (
   <div className="absolute bg-gray-300 grid grid-cols-1 md:grid-cols-4 gap-8">
    {/* Columna Izquierda: Calculadora y Tu Inmueble */}
        <div className="md:col-span-1">
            ...
            <h2 className="text-xl font-bold mb-4">Tu inmueble</h2>
            <ul>
        ...
        <h2 className="text-2xl font-bold mb-4">Guías</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <ToolCard
                title="Simula tu crédito hipotecario desde el detalle del inmueble"
                description=""
                imageUrl="https://via.placeholder.com/300x150?text=Guia+Credito" // Replace with actual image
            />
            <ToolCard
                title="Nuevos paquetes de publicación en Metrocuadrado"
                description=""
                imageUrl="https://via.placeholder.com/300x150?text=Guia+Paquetes" // Replace with actual image
            />
            <ToolCard
                title="Construye tu plan de pagos para comprar vivienda sobre planos"
                description=""
                imageUrl="https://via.placeholder.com/300x150?text=Guia+Planes" // Replace with actual image
            />
            </div>
            <h2 className="text-2xl font-bold mb-4">Otras guías</h2>
